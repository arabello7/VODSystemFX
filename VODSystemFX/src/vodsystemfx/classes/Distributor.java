...
public class Distributor implements Runnable, Serializable {
    ...
    /** Method was suppose to prevent names repetition but something went wrong.
     * @return new name for distributor
     */
...
//                    newName = FileWorm.readFile(randomName, "distributors.txt");
//                }
//            }
//        }
//        return newName;
